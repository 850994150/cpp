...
/*
//打印两节点的路径
void PrintPath(BiTree root, vector<int> path,int length)
{
    if (root) {
...
int main()
{
    ...
    */
    ...
    cout << endl
         << "8. 树的高/深度为：" << BinTreeDepth(T) << endl
         << endl;

    cout << "结点数" << getNodeNum(T) << endl
         << endl;

    cout << "9. 求二叉树第K层的节点个数" << endl;
    int k;
    cin >> k;
    cout << "个数为:" << GetNodeNumKthLevel(T, k) << endl
         << endl;

    cout << "10. 二叉树中叶子节点的个数\n";
    cout << GetLeafNodeNum(T) << endl
         << endl;
